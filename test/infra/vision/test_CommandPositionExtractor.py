...
class TestLetterPositionExtractor(TestCase):
    ...
    def test_givenAnImageWhenReceiveLetterListThenReturnPanelLetterList(
        ...
        command_panel_letter_position_extractor.extract_letters_from_image(image)
        list_of_panel_letter = (
            command_panel_letter_position_extractor.get_extracted_letters()
        )
