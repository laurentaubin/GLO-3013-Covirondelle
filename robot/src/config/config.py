...
PUCK_ALIGNMENT_Y_CENTER_POSITION = 320
PUCK_ALIGNMENT_HORIZONTAL_THRESHOLD = 10
PUCK_ALIGNMENT_UP_THRESHOLD = 320
ALIGNED_OHMMETER_HORIZONTAL_POSITION = 327
OHMMETER_ALIGNMENT_THRESHOLD = 2
IMAGE_CENTER_POSITION = (320, 200)
...
# Gripper servos
OPEN_GRIPPER_TARGET = 8000
CLOSE_GRIPPER_TARGET = 5000
MOVE_GRIPPER_UP_TARGET = 5250
MOVE_GRIPPER_DOWN_TARGET = 6250
