                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                        <Paper className={classes.smallPaper}>
                            <DataCard title={"Charge électrique de la batterie"} value={state.BatteryElectricCharge}
                                      unit={"Watt"}/>
                        </Paper>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <Paper className={classes.smallPaper}>
                            <DataCard title={"Consommation électrique du robot"} value={state.RobotConsumption}
                                      unit={"Watt"}/>
                        </Paper>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <Paper className={classes.smallPaper}>
                            <DataCard title={"Temps restant à la batterie"} value={state.BatteryTime}
                                      unit={"secondes"}/>
                        </Paper>
                    </Grid>
                    <Grid item xs={12} sm={6}>
