...
class VerticalAlignmentCorrector:
    def __init__(
        self,
    ...
    def correct_vertical_alignment(self, puck_color: Color):
...
if __name__ == "__main__":
    ...
    vertical_alignment_corrector.correct_vertical_alignment(puck_color_to_align)
